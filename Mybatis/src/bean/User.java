...
public class User {
    ...
    private String applicationTimeString;
    ...
    public String getApplicationTimeString() {
		return applicationTimeString;
	}

	public void setApplicationTimeString(String applicationTimeString) {
		this.applicationTimeString = applicationTimeString;
	}
